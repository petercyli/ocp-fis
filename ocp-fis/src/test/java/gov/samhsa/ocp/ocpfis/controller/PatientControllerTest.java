...
public class PatientControllerTest {
    ...
    public void testGetPatentByValue() throws Exception {
        ...
        Mockito.when(patientService.getPatientsByValue(Mockito.anyString(), Mockito.anyString(), Mockito.any(Optional.class), Mockito.any(Optional.class), Mockito.any(Optional.class), Mockito.any(Optional.class), Mockito.any(Optional.class))).thenReturn(pageDto);
