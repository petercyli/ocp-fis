...
public class ParticipantControllerTest {
    ...
    public void testMethod_Given_RelatedPersonsAvailable_When_RequestedWithTypeAndValueForAPatient_Then_ReturnListOfParticipants() throws Exception {
        ...
        Integer page = 1;
        Integer size = 10;
        Mockito.when(participantService.getAllParticipants(eq("2421"), eq(ParticipantTypeEnum.relatedPerson), eq(RELATED_PERSON_NAME), Mockito.any(Optional.class), Mockito.any(Optional.class), Mockito.any(Optional.class))).thenReturn(pageDto);
    ...
    public void testMethod_Given_OrganizationsAvailable_When_RequestedWithTypeAndValueForAPatient_Then_ReturnListOfParticipants() throws Exception {
        ...
        Integer page = 1;
        Integer size = 10;
        Mockito.when(participantService.getAllParticipants(eq("2421"), eq(ParticipantTypeEnum.organization), eq(ORGANIZATION_NAME), Mockito.any(Optional.class), Mockito.any(Optional.class), Mockito.any(Optional.class))).thenReturn(pageDto);
    ...
    public void testMethod_Given_PatientsAvailable_When_RequestedWithTypeAndValueForAPatient_Then_ReturnListOfParticipants() throws Exception {
        ...
        Integer page = 1;
        Integer size = 10;
        Mockito.when(participantService.getAllParticipants(eq("2421"), eq(ParticipantTypeEnum.patient), eq(PATIENT_NAME), Mockito.any(Optional.class), Mockito.any(Optional.class), Mockito.any(Optional.class))).thenReturn(pageDto);
