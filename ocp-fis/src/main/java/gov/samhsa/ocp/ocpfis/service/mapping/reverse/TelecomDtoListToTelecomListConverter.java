        ...
        if (source != null && source.size() > 0) {
            ...
            for (TelecomDto tempTelecomDto : source) {
                ...
                if (tempTelecomDto.getValue() != null)
                    tempTelecom.setValue(tempTelecomDto.getValue().orElse(""));
                if (tempTelecomDto.getSystem() != null)
                    tempTelecom.setSystem(ContactPoint.ContactPointSystem.valueOf(tempTelecomDto.getSystem().orElse("")));
                if (tempTelecomDto.getUse() != null)
                    tempTelecom.setUse(ContactPoint.ContactPointUse.valueOf(tempTelecomDto.getUse().orElse("")));
