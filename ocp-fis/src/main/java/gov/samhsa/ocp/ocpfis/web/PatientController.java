...
public class PatientController {
    ...
    @GetMapping("/search")
    public Set<PatientDto> searchPatientsByValue( @RequestParam(value = "value") String value,@RequestParam(value = "type") String type,@RequestParam(value = "showInactive") boolean showInactive) {
