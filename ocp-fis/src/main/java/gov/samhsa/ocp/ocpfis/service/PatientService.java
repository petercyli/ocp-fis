...
public interface PatientService {
    ...
    PageDto<PatientDto> getPatientsByValue(Optional<String> key, Optional<String> value, Optional<String> organization, Optional<Boolean> assigned, Optional<String> careTeamPractitioner, Optional<Boolean> showInactive, Optional<Integer> pageNumber, Optional<Integer> pageSize,Optional<Boolean> showAll);
