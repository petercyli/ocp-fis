...
public interface RelatedPersonService {
    ...
    PageDto<RelatedPersonDto> searchRelatedPersons(String searchKey, String searchValue, Optional<Boolean> showInactive, Optional<Integer> pageNumber, Optional<Integer> pageSize);
