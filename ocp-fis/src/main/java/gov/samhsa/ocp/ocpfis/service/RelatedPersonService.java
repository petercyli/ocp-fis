...
public interface RelatedPersonService {
    ...
    PageDto<RelatedPersonDto> searchRelatedPersons(SearchKeyEnum.SearchType searchType, String searchValue, Optional<Boolean> showInactive, Optional<Integer> pageNumber, Optional<Integer> pageSize);
