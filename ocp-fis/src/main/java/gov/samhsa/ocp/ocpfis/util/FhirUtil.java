...
public class FhirUtil {
    ...
    public static List<Bundle.BundleEntryComponent> getAllBundlesComponentIntoSingleList(Bundle bundle, IGenericClient fhirClient, FisProperties fisProperties) {
